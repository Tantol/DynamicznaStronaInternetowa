...
ORDER BY $kolumna_sort ASC";
	...
	if(($zbiorWierszy==null)||(sqlsrv_has_rows($zbiorWierszy)== false)){
		...
		$komendaSql= "SELECT IdKlient, Imie, Ulica, Miejscowosc, NrDomu, NrBudynku, KodPocztowy, Poczta, NrTelefonu, Email, Pesel, Nip, Regon, Fax
FROM dbo.Klient
ORDER BY IdKlient ASC;";
		...
		print("<table>
				<thead>
				 <tr>
				 <td><a href='pracownicyTabela.php?sortuj=IdPracownika'>IdKlienta</a></td>
