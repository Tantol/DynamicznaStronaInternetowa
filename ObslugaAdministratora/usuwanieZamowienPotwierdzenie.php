...
print("<div id='element_z_tlem'> <h3>Usuwanie danych klienta</h3>");
...
require_once "../polaczenieZBZ.php";
	...
	$komenda_sql = "DELETE dbo.Ladunek WHERE IdZamowienia = $IdPracownika;
DELETE dbo.Zamowienie WHERE IdZamowienia = $IdPracownika;";
	...
	if ($rezultat == false)
	{
		...
		print("<p class='sukces'>Dane zamowienia o id rownym <strong>$IdPracownika</strong> zostały usunięte z bazy.</p>");
	else if ($wiersze_zmienione == 0)
		print("<p>W bazie nie ma pracownika o identyfikatorze <strong>$IdPracownika</strong>.</p>");
		
	print("<p> <br /><a href='wykazZamowien.php'>Powrót do wykazu zamowien</a></p></div>");
