...
$IdPracownika = $_GET["IdPracownik"];
	...
	print("<p>Czy na pewno usun±ć zamowienie o identyfikatorze <strong>$IdPracownika</strong>?<p>");
	print("<p><a href='usuwanieZamowienPotwierdzenie.php?IdPracownika=$IdPracownika'>Tak</a>&nbsp;&nbsp;&nbsp;
	<a href='wykazZamowien.php'>Nie</a></p>");

	print("<p><a href='wykazZamowien.php'> Powrot do wykazu zamowien </a></p> </div>");}
